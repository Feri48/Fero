...
with col2:
    load_kw = st.number_input("Terhelés [kW]", min_value=2.0, max_value=200.0, value=9.0, help="A valós terhelés kW-ban.")
    power_factor = st.number_input("Teljesítménytényező", min_value=0.9, max_value=1.0, value=1.0,help="Jellemzően 0.9-1.0 között")
...
with col3:
    ...
    battery_count = st.slider("Akkumlátorok száma", min_value=1, max_value=40, value=40, help="Akkuk száma egy stringben.")


#if calc_button:                     # A  st.button("Számítás")  számítások csak akkor történnek meg, ha a gombot megnyomták
...
#  3 colum verz. müködőképes verzió: 1.4.7 file   gomb nélkül 
# 2025.06.05.
# python -m streamlit run UPS_szamolo_ver1_4_7.py
